...
class GripperActionServer(object):
    def __init__(self):
        ...
        self._gripper = franka_interface.GripperInterface(gripper_joint_names = ['robot_arm_finger_joint1', 'robot_arm_finger_joint2'])
    ...
    def _update_feedback(self, position):
        self._fdbk.position = self._gripper.joint_position('robot_arm_finger_joint1')
        self._fdbk.effort = self._gripper.joint_effort('robot_arm_finger_joint1')
    ...
    def _check_state(self, position):
        return fabs(self._gripper.joint_position('robot_arm_finger_joint1') - position) <= 0.01
